            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="department.teamLeader.label" default="Team Leader" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${departmentInstance?.teamLeader?.id}">${departmentInstance?.teamLeader?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="department.members.label" default="Members" /></td>
