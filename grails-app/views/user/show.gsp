            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.code.label" default="Code" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "code")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.allocations.label" default="Allocations" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.requests.label" default="Requests" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.approvals.label" default="Approvals" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.photoPath.label" default="Photo Path" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "photoPath")}</td>
