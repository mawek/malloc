	...
	<div class="body">
		...
		<g:form action="save" enctype="multipart/form-data">
			...
			<div class="dialog">
				<table>
					<tbody>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="code"><g:message code="user.code.label" default="Code" /> </label>
							</td>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="name"><g:message code="user.name.label" default="Name" /> </label>
							</td>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="surname"><g:message code="user.surname.label" default="Surname" /> </label>
							</td>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="email"><g:message code="user.email.label" default="Email" /> </label>
							</td>
						...
						<tr class="prop">
							...
							<td valign="top" class="value ${hasErrors(bean: user, field: 'department', 'errors')}"><g:select name="department.id"
									from="${malloc.Department.list()}" optionKey="id" value="${user?.department?.id}" noSelection="['null': '']" />
							</td>
						</tr>


						<tr class='prop'>
							<td valign='top' class='name'><label for='photoFile'><g:message code="user.photo.label" default="Photo" /> </label>
							</td>
							<td valign='top' class='value ${hasErrors(bean:user,field:'photoPath','errors')}'><input type="file" name="photoFile" />
							</td>
						</tr>
			...
			<div class="buttons">
				<span class="button">
					<g:if test="${user?.id}">
						<g:submitButton name="create" class="save" value="${message(code: 'default.button.edit.label', default: 'Send')}" />
					</g:if> <g:else>
