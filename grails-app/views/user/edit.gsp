                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="allocations"><g:message code="user.allocations.label" default="Allocations" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'allocations', 'errors')}">
                                    
<ul>
<g:each in="${userInstance?.allocations?}" var="a">
    <li><g:link controller="allocation" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="allocation" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'allocation.label', default: 'Allocation')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="requests"><g:message code="user.requests.label" default="Requests" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'requests', 'errors')}">
                                    
<ul>
<g:each in="${userInstance?.requests?}" var="r">
    <li><g:link controller="allocation" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="allocation" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'allocation.label', default: 'Allocation')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="approvals"><g:message code="user.approvals.label" default="Approvals" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'approvals', 'errors')}">
                                    
<ul>
<g:each in="${userInstance?.approvals?}" var="a">
    <li><g:link controller="allocation" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="allocation" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'allocation.label', default: 'Allocation')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="photoPath"><g:message code="user.photoPath.label" default="Photo Path" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'photoPath', 'errors')}">
                                    <g:textField name="photoPath" value="${userInstance?.photoPath}" />
                                </td>
                            </tr>
